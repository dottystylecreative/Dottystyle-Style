...
if (count($contacts) > 1) {
     ...
     $string .= '
        <div '.$this->ctf_title_style.' class="label">
...
$string .= '
     ...
     $string .= '</label>
        ...
        <div '.$this->ctf_title_style.' class="label">
                <label for="si_contact_organisation'.$form_id_num.'">';
     $string .=  __('Your Organisation', 'si-contact-form').':';
     $string .= '</label>
        </div>
        <div '.$this->ctf_field_div_style.'>'.$this->ctf_echo_if_error($si_contact_error_name).'
                <input '.$this->ctf_field_style.' type="text" id="si_contact_organisation'.$form_id_num.'" name="si_contact_organisation" value="' . $this->ctf_output_string($name) .'" '.$this->ctf_aria_required.' size="'.$ctf_field_size.'" />
        </div>
...
';
    ...
    $string .= '
     ...
     $string .= '</label>
        ...
        <div '.$this->ctf_title_style.' class="label">
                <label for="si_contact_number'.$form_id_num.'">';
     $string .=  __('Your Telephone', 'si-contact-form').':';
     $string .= '</label>
        </div>
        <div '.$this->ctf_field_div_style.'>'.$this->ctf_echo_if_error($si_contact_error_name).'
                <input '.$this->ctf_field_style.' type="text" id="si_contact_number'.$form_id_num.'" name="si_contact_number" value="' . $this->ctf_output_string($name) .'" '.$this->ctf_aria_required.' size="'.$ctf_field_size.'" />
        </div>
';
  }
}
